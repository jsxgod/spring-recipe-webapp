package js.springexamples.recipeapp.bootstrap;

import js.springexamples.recipeapp.model.*;
import js.springexamples.recipeapp.repositories.CategoryRepository;
import js.springexamples.recipeapp.repositories.RecipeRepository;
import js.springexamples.recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("Getting recipes and saving them.");
    }
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> cupUOMOptional = unitOfMeasureRepository.findByUnit("Cup");
        ...
        if(!americanCategoryOptional.isPresent()){
            throw new RuntimeException("Expected Meal Category Not Found");
        }
        ...
        guacNotes.setNoteText("For a very quick guacamole just take a 1/4 cup of salsa and mix it in with your mashed avocados.\n" +
        ...
        tacoNotes.setNoteText("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
